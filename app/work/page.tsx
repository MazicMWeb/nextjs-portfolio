  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <h2 className="font-medium text-xl mb-1 tracking-tighter">VigilEye</h2>
        ...
        <hr className="my-6 border-neutral-100 dark:border-neutral-800" />
        <h2 className="font-medium text-xl mb-1 tracking-tighter">AI-ATAR anigma AI - Welyne</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
        ...
        <hr className="my-6 border-neutral-100 dark:border-neutral-800" />
        <h2 className="font-medium text-xl mb-1 tracking-tighter">Midity atlantic Dunes</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
